...
const SocialLinks = ({ className }: Props): JSX.Element => (
  <SocialLinksSt className={className}>
    <li>
      <a
        href="https://github.com/matfin/"
        rel="external"
        title="matfin (Matt Finucane)"
      >
    ...
    <li>
      <a
        href="https://twitter.com/matfinucane"
        rel="external"
        title="matfinucane on Twitter"
      >
    ...
    <li>
      <a
        href="https://www.linkedin.com/in/mattfinucane/"
        rel="external"
        title="Matt Finucane on LinkedId"
      >
    ...
    <li>
      <a
        href="https://stackoverflow.com/users/1515180/matfin"
        rel="external"
        title="Matt Finucane on StackOverflow"
      >
